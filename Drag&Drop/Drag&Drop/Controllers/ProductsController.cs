...
namespace Drag_Drop.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CatalogNumber,Name,Ingredients,SideEffect,Usage,PhotoURL,Quantity,Price,RegisterOn,TypeProductId")] Product product)
        {
