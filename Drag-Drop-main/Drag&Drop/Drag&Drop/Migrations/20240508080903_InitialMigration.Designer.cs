...
namespace Drag_Drop.Migrations
{
    ...
    [Migration("20240508080903_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Drag_Drop.Data.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Drag_Drop.Data.TypeProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Drag_Drop.Data.Order", b =>
                {
                    b.HasOne("Drag_Drop.Data.Client", "Clients")
                        .WithMany("Orders")
                        .HasForeignKey("ClientId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Drag_Drop.Data.Product", "Products")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Drag_Drop.Data.Client", null)
                        .WithMany()
